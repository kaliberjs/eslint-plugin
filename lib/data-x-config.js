...
module.exports = {
  ...
  /**
   * Action verbs that may be used without a "-target" suffix.
   * Used by: data-x-onpage-action-format
   */
  standaloneActionVerbs: ['submit'],
  ...
  /**
   * Get standalone action verbs as a regex pattern string (for use in RegExp)
   */
  getStandaloneActionVerbPattern() {
    return this.standaloneActionVerbs.join('|')
  },
