...
`eslint-plugin-jsdoc` is an **optional peer dependency** — it is not installed for
you, so projects that don't use this preset don't carry it. Install it alongside:
