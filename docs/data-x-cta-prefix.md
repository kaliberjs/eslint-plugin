...
This rule enforces that `<a>` elements acting as call-to-action links use the "cta-" prefix in their `data-x` attribute. Common CTA actions include: apply, submit, register, sign up, download, contact, etc.
